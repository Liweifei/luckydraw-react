...
import store from "@/tools/flux/store"//引入store拿需要的数据并触发更新事件
import action from "@/tools/flux/actions"//flux 触发更新数据动作，将store的数据更新
  ...
  render() {
    ...
    return (
      <div className="appLogin">
        <i className="count">{self.state.num}</i>
          ...
          <div className="formBox">
            ...
            <div className="content">
              <Form onSubmit={this.login}>
                ...
                <Button className="confirmBtn"  htmlType="submit" type="primary">点击执行flux</Button>
              </Form>
            </div>
          </div>
